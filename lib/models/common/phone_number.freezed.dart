...
abstract class $PhoneNumberCopyWith<$Res> {
  ...
  @useResult
  $Res call({String number, PhoneType type});
}
...
class _$_PhoneNumber implements _PhoneNumber {
  const _$_PhoneNumber({this.number = '', this.type = PhoneType.mobile});
...
abstract class _PhoneNumber implements PhoneNumber {
  const factory _PhoneNumber({final String number, final PhoneType type}) =
      _$_PhoneNumber;
